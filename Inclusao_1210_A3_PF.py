...
# Clica no Elemento pelo ID CSS
def clicar_elemento_ID(id):
    navegador_instancia.clicarElementoID(id, Browser)

# Preencher Letra por leta OBS: Definido pelo XPATH
def preencher_campo_letra_a_letra(selector, value):
    navegador_instancia.escreverElementoLetra(selector, value)
    sleep(0.5)
